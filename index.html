<!DOCTYPE html>	<?php
  $bg = array('magic.jpg','2.jpg','3.jpg','4.jpg' ); // array of filenames
...
<!DOCTYPE html>	<?php
   ...
   "<pre class='text-danger' style='margin-left: 32%; height: auto;
  ...
  88bd8b,d88b  d888b8b   d888b8b    88b d8888b    ?88,.d88b,  88bd88b d8888b ?88,  88P?88   d8P 
  88P.`?8P.?8bd8P. ?88  d8P. ?88    88Pd8P. `P    `?88.  ?88  88P.  `d8P. ?88 `?8bd8P.d88   88  
 d88  d88  88P88b  ,88b 88b  ,88b  d88 88b          88b  d8P d88     88b  d88 d8P?8b, ?8(  d88  
d88. d88.  88b`?88P.`88b`?88P.`88bd88. `?888P.      888888P.d88.     `?8888P.d8P. `?8b`?88P.?8b 
                               )88                  88P.      == RazorUndead ==             )88
                              ,88P                 d88                                     ,d8P
                          `?8888P                  ?8P                                   `?888P 
...
$$ | $$ | $$ |$$  __$$ |$$ |  $$ |$$ |$$ |            $$ |  $$ |$$ |      $$ |  $$ | $$  $$<  $$ |  $$ |      
$$ | $$ | $$ |\$$$$$$$ |\$$$$$$$ |$$ |\$$$$$$$\       $$$$$$$  |$$ |      \$$$$$$  |$$  /\$$\ \$$$$$$$ |      
\__| \__| \__| \_______| \____$$ |\__| \_______|      $$  ____/ \__|       \______/ \__/  \__| \____$$ |      
                        $$\   $$ |                    $$ |                                    $$\   $$ |      
                        \$$$$$$  |                    $$ |        == RazorUndead ==           \$$$$$$  |      
                         \______/                     \__|                                     \______/       
 ...
 ___      ___       __       _______   __     ______         _______    _______     ______  ___  ___  ___  ___     
|"  \    /"  |     /""\     /" _   "| |" \   /" _  "\       |   __ "\  /"      \   /    " \|"  \/"  ||"  \/"  |    
 \   \  //   |    /    \   (: ( \___) ||  | (: ( \___)      (. |__) :)|:        | // ____  \\   \  /  \   \  /     
 /\\  \/.    |   /. /\  \   \/ \      |:  |  \/ \           |:  ____/ |_____/   )/  /    ) :)\\  \/    \\  \/      
|: \.        |  //  __.  \  //  \ ___ |.  |  //  \ _        (|  /      //      /(: (____/ // /\.  \    /   /       
|.  \    /:  | /   /  \\  \(:   _(  _|/\  |\(:   _) \      /|__/ \    |:  __   \ \        / /  \   \  /   /        
|___|\__/|___|(___/    \___)\_______)(__\_|_)\_______)    (_______)   |__|  \___) \"_____/ |___/\___||___/         
                                                                          == RazorUndead ==                                           
...
'  ); // array of filenames
  "</pre>";
  $i = rand(0, count($logo)-1); // generate random number size of the array
  $selectedlogo = "$logo[$i]"; // set variable equal to which random filename was chosen
?>
...
<html lang="en">
	...
	<head><base href="../">
		...
		<link rel="shortcut icon" href="magic.ico" />
		<!--begin::Fonts-->
	...
	<link href="/magic/style.css" rel="stylesheet" type="text/css" />
		<link href="style.bundle.css" rel="stylesheet" type="text/css" />
<link href="/css/style-9.css" rel="stylesheet" type="text/css" />
<link href="mana.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
<!--
body{
background: url(<?php echo $selectedBg; ?>) no-repeat center ;
...
-->
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed magic">

<svg class="wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,256L48,245.3C96,235,192,213,288,202.7C384,192,480,192,576,192C672,192,768,192,864,192C960,192,1056,192,1152,176C1248,160,1344,128,1392,112L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>

<pre class="text-danger " style="margin-left: 32%; height: auto;
                     background-repeat:no-repeat;
                    background-size: cover;	
					
					position: absolute;margin-top:40px"><?php echo $selectedlogo; ?></pre>


						  <svg class="wavebottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
						  
						  
						  
  <path fill="#330134" fill-opacity="1" d="M0,160L720,288L1440,96L1440,320L720,320L0,320Z"></path>
</svg>
	
	<div class="d-flex flex-column flex-root" style="margin-top:90px">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						<!--begin::Container-->
						<div class="container-fluid d-flex align-items-stretch justify-content-between  p-3 mb-5 bg-body rounded">
														...
														<div data-kt-search-element="results" class="d-none">
															...
															<div class="scroll-y mh-200px mh-lg-350px">
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	<!--begin::Symbol-->
																	<div class="symbol symbol-40px me-4">
																		<img src="assets/media/avatars/10-3.jpg" alt="" />
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																	<div class="d-flex flex-column justify-content-start fw-bold">
...
-->
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div  class=" btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px">
												<!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
												<a href="#creator_card">&nbsp;&nbsp;Creator Cards</a>
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
												<!--begin::Heading-->
												<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/media/misc/bg-2.jpg')">
													<!--begin::Title-->
       ...
       <h3 class="card-title fw-bolder text-white">Put Cards Here</h3>
        <section class="ml-4 mr-2 flex">
    
   
												<div class="card-toolbar">
				
													<button id="shareUrl" type="button" class="btn btn-sm btn-icon btn-color-white btn-danger btn-color pulse pulse-primary border-0 me-n3" data-kt-menu-trigger="click">
														<!--begin::Svg Icon | path: icons/duotune/general/gen024.svg--><span class="pulse-ring "></span>
														<span class="svg-icon svg-icon-2 ">🔗
    ...
    <div class="fv-row mb-10">
        ...
        <!--begin::Input-->
        <textarea id="cards" name="textarea_input" class="cards form-control form-control-solid h-200px mt-n20">
2 Duress (M19)
1 Gyome, Master Chef
...
1 Ashiok, Nightmare Muse
	...
	<form id="kt_docs_formvalidation_textarea" class="form" action="#" autocomplete="off">
	 ...
	 <div class="card-toolbar">
													<!--begin::Menu-->
													  <div class="card-header ribbon ribbon-end mt-n10">
        <div class="ribbon-label bg-danger">Token's</div>
       
    </div>
													</div>
 <textarea id="extra_tokens" name="textarea_input" class="form-control form-control-solid h-80px mt-n10 ">
1 Squirrel (UND)
1 Shark
...
<form id="kt_docs_formvalidation_textarea" class="form" action="#" autocomplete="off">
	 <div class="fv-row mb-40">
	  <div class="card-toolbar">
													<!--begin::Menu-->
													  <div class="card-header ribbon ribbon-end mt-n10">
        <div class="ribbon-label bg-danger">Emblem's</div>
       
    </div>
	</div>
<textarea id="extra_emblems" name="textarea_input" class="form-control form-control-solid h-80px mt-n10">
...
Teferi, Hero of Dominaria
	...
	<div class=" align-items-center mb-5 my-2">
														
														<!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
														 <button class="align-items-center display btn btn-danger  btn-active-light-success btg-lg"> Search
														 	</button>

														
														 <button class=" align-items-center print btn btn-danger btn-active-light-warning btg-lg"> Print
														 	</button>
															
															
															
															 <button class=" align-items-center print btn btn-danger btn-active-light-warning btg-lg "> Print for MPC
														 	</button>
													</div>
...
<form id="kt_docs_formvalidation_tagify" class="form" action="#" autocomplete="off">
    ...
    <div class="fv-row mb-10">
        <!--begin::Label-->
        <label class="required fw-bold fs-6 mb-2">Langue</label>
        <!--end::Label-->
...
<select class="mb-2 size form-select"  aria-label="Select example">
      <option value="normalSize">Crop Mark</option>
      <option value="smallSize">No Crop Mark</option>
  ...
  <select class="mb-2 size form-select"  aria-label="Select example">
    ...
    <select class="mb-2 gutter form-select">
    ...
    <select class="mb-2 sheet form-select">
...
<!--end::Form-->
										...
										<div class="card card-xl-stretch ">
											...
											<div class="card-header  align-items-center border-0 mt-4 ">
													...
													<div class="overflow-auto ">
																<!--begin::Notice-->
																<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed w-auto    p-6">
																	<!--begin::Icon-->
																	<script type="text/javascript" >function reateCardAsText(cardName)</script>
																	...
																	<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap ">
																		...
																		<div class="mb-3 mb-md-0 fw-bold">
																			<h4 class="text-gray-900 fw-bolder">Cards selector</h4>
																			<div class="fs-6 text-gray-700 pe-7">You can select set collection of each card ==>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              </div>
																		</div>
																		<!--end::Content-->
																		<!--begin::Action-->
																		<div class=" align-items-center mb-5 my-2">
																		
																		<select  id="pills-tab" role="tablist"  class='btn btn-danger input  size form-select'>
									
      <option value="Standard-3">Select one collection Set</option>
      <option value="smallSize">No Crop Mark</option>
 ...
 <div class="container-fluid error  pulse pulse-primary alert alert-warning alert-danger fade show  ml-2 mr-4 justify-center md-justify-start flex flex-wrap">
      <button type="button" class="btn-close position-absolute position-absolute top-0 end-0" data-bs-dismiss="alert" aria-label="Close" onclick="this.parentElement.classList.toggle('hidden');"></button>
     <div class="d-flex flex-column">
        <span class="mb-1 pulse pulse-primary bold"> <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>Sorry. We could not find this cards:</span>
		<hr>
        <ul style="list-style: inside disc;"></ul>
      </div>
    
	</div>
  <main class="deck shadow p-3 mb-5 bg-body rounded align-items-center overflow-y ml-2 mr-4 justify-center md-justify-start flex flex-wrap align-content-start">
  </main>
								...
								<div class="row gy-5 g-xl-8">
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch mb-xl-8">
											<!--begin::Header-->
											<div class="card-header border-0">
												<h3 class="card-title fw-bolder text-dark">Scan Cards</h3>
												<div class="card-toolbar">
													<!--begin::Menu-->
													<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
														<!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
								...
								<!--end::Row-->
								<!--begin::Row-->
								<div id="creator_card" class="row g-5 g-xl-8">
									<!--begin::Col-->
									<div class="col-xl-8">
										...
										<div  class="card card-xxl-stretch  mb-xl-8">
											...
											<div class="d-flex align-items-center bg-light-info rounded p-5">
													...
													<!--begin::Title-->
													<div  class="flex-grow-1 me-2">
														<a class=" fw-bolder text-gray-800 text-hover-primary fs-6">We can build your card here and Download It!!! Or put into text list for directly print &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;           </a>
														<span class="text-muted fw-bold d-block">Just take 5 minutes</span>
														 <button class=" align-items-center print btn btn-danger btn-active-light-warning btg-lg ms-2"> tutorial
														 	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<path d="M18.3721 4.65439C17.6415 4.23815 16.8052 4 15.9142 4C14.3444 4 12.9339 4.73924 12.003 5.89633C11.0657 4.73913 9.66 4 8.08626 4C7.19611 4 6.35789 4.23746 5.62804 4.65439C4.06148 5.54462 3 7.26056 3 9.24232C3 9.81001 3.08941 10.3491 3.25153 10.8593C4.12155 14.9013 9.69287 20 12.0034 20C14.2502 20 19.875 14.9013 20.7488 10.8593C20.9109 10.3491 21 9.81001 21 9.24232C21.0007 7.26056 19.9383 5.54462 18.3721 4.65439Z" fill="black" />
															</svg></button>
															 <button class=" align-items-center print btn btn-danger btn-active-light-warning btg-lg ms-2" onclick='downloadCard();'> Download card
														 	</button>
															 <button class=" align-items-center print btn btn-danger btn-active-light-warning btg-lg ms-2"> Put in text deck
														 	</button>
													</div>
													<!--end::Title-->
													<!--begin::Lable-->
											...
											<canvas class=' shadow  flex flex-wrap align-content-start' id='previewCanvas' widht='60px' height='380px' ></canvas>
									...
									<div class="col-xl-4">
										...
										<div class="card card-xxl-stretch mb-5  mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1">Options creator</span>
													<span class="text-muted mt-1 fw-bold fs-7">Make proxy fun</span>
												</h3>
...
<div id='frame-element-editor' class='frame-element-editor'>
			...
			<div>
				...
				<button onclick='frameElementMaskRemoved();' class='input align-items-center print btn btn-danger btn-active-light-warning btg-lg'>Remove mask</button>
			...
			<div class='drop-area'>
	            ...
	            <input type='file' multiple accept='.png, .svg, .jpg, .jpeg, .bmp' placeholder='File Upload' class='input' oninput='uploadFiles(event.target.files, uploadMaskOption);' data-dropFunction='uploadMaskOption' data-otherParams=''>
												...
												<div class='rounded align-items-center overflow-y ml-2 mr-4 justify-center md-justify-start flex flex-wrap align-content-start'>
				
				
  
  <select  id="pills-tab" role="tablist"  class='btn btn-danger input mb-2 size form-select'>
									<option value='Standard-3' onclick='toggleCreatorTabs(event, "frame")'>Frames</option>
									<option value='Standard-3' onclick='toggleCreatorTabs(event, "import")'>Regular</option>
								<option value='Standard-3' onclick='toggleCreatorTabs(event, "setSymbol")'>Set Symbols</option>
								<option value='Standard-3' onclick='toggleCreatorTabs(event, "text")'>text</option>
								<option value='Standard-3' onclick='toggleCreatorTabs(event, "watermark")'>Watermark</option>
								<option value='Standard-3' onclick='toggleCreatorTabs(event, "bottomInfo")'>Saves</option>
								<option value='Standard-3' onclick='toggleCreatorTabs(event, "art")'>Art</option>
								<option value='Standard-3'  onclick='toggleCreatorTabs(event, "import")'>Import</option>
								</select>
				...
				<div id='creator-menu-sections' class='margin-bottom'>
					<div id='creator-menu-frame'>
						<div class=''>
							...
							<div class='input-grid margin-bottom'>
								<select id='selectFrameGroup' onchange='loadScript("/js/frames/group" + this.value + ".js")' class=' input mb-2 size form-select'>
								...
								<select id='selectFramePack' onchange='loadScript("/js/frames/pack" + this.value + ".js")' class='input  mb-2 size form-select'></select>
							</div>
							<div class='input-grid margin-bottom'>
								<button id='loadFrameVersion' class='input mb-2 size form-select'>Load Frame Version</button>
							</div>
						...
						<div class='readable-background margin-bottom padding'>
							...
							<div class='input-grid margin-bottom'>
								<button id='addToFull' class='input align-items-center print btn btn-danger btn-active-light-warning btg-lg' onclick='addFrame()'>Add Frame to Card</button>
								<button id='addToRightHalf' class='input align-items-center print btn btn-danger btn-active-light-warning btg-lg' onclick='addFrame([{src:"/img/frames/maskRightHalf.png", name:"Right Half"}])'>Add Frame to Card (Right Half)</button>
							</div>
							<h5 class='collapsible collapsed padding input-description' onclick='toggleCollapse(event);'>More options</h5>
								<div>
									<div class='input-grid margin-bottom'>
										<button id='addToLeftHalf' class='input align-items-center print btn btn-danger btn-active-light-warning btg-lg' onclick='addFrame([{src:"/img/frames/maskLeftHalf.png", name:"Left Half"}])'>Add Frame to Card (Left Half)</button>
										<button id='addToMiddleThird' class='input align-items-center print btn btn-danger btn-active-light-warning btg-lg' onclick='addFrame([{src:"/img/frames/maskMiddleThird.png", name:"Middle Third"}])'>Add Frame to Card (Middle Third)</button>
									</div>
					...
					<div id='creator-menu-text' class='hidden'>
						<div class='readable-background padding margin-bottom'>
							...
							<div id='text-options' class='input-grid btn btn-warning'></div>
						</div>
						<div class='readable-background padding margin-bottom'>
					...
					<div id='creator-menu-import' class='hidden'>
						<div class='readable-background margin-bottom padding'>
							...
							<input id='import-name' class='input margin-bottom' type='text' onchange='fetchScryfallData(this.value, importCard);' placeholder='enter card search'>
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '800px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none rounded-0">
				<!--begin::Header-->
				<div class="card-header" id="kt_activities_header">
					<h3 class="card-title fw-bolder text-dark">FAQs</h3>
					<div class="card-toolbar">
 ...
 <script src='/js/themes.js'></script>
  ...
  <script>
	...
	customElements.define('mtg-mana-cost', ManaCost);
		...
		<script src="upgrade-plan.js"></script>
